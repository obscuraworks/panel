...
export interface Server {
    ...
    // [ADDED] Apakah user yang sedang login adalah owner server ini
    serverOwner: boolean;
    // [ADDED] Status privasi server — true = admin diblokir dari Client Panel
...
export const rawDataToServerObject = ({ attributes: data }: FractalResponseData): Server => ({
    ...
    // [ADDED] Map dari API response ke camelCase
    serverOwner: data.server_owner ?? false,
    hideFromAdmin: data.hide_from_admin ?? false,
});
