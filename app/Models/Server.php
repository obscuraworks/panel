 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Server whereHideFromAdmin($value)
...
class Server extends Model implements Identifiable
{
    ...
    public static array $validationRules = [
        ...
        'hide_from_admin' => 'sometimes|boolean',
    ];
    ...
    protected $casts = [
        ...
        // [ADDED] Cast kolom baru ke boolean
